...
if is_admin():
    ...
    while True:     
        current_time = datetime.datetime.now().strftime("%H:%M")
        website_list = ["www.facebook.com", "www.instagram.com", "www.twitter.com", "www.linkedin.com", "www.reddit.com", "www.pinterest.com", "www.tiktok.com"]    #Enter the websites that you want to block
        if (current_time >= Stop_time):
